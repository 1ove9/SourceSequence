        ...
        <div className="grid grid-cols-12 gap-x-8 gap-y-12">
          ...
          <div className="col-span-12 md:col-span-5">
            ...
            >
              ...
              <a
                href="#"
                className="underline-sweep mt-8 inline-flex items-center gap-1.5 font-mono text-[12px] uppercase tracking-[0.18em] text-foreground/80 hover:text-foreground"
              >
                All publications
                ...
                >
                  <GlassCard hover thin className="overflow-hidden">
                    ...
                    >
                      ...
                      <span className="flex-1 truncate text-[14.5px] font-medium text-foreground transition-colors group-hover:text-[color:var(--primary)]">
                        {p.title}
                      </span>
                      <span className="hidden shrink-0 font-mono text-[10px] tracking-[0.22em] text-muted-foreground md:inline">
                        {p.venue}
                      </span>
                      <ArrowUpRight className="h-4 w-4 shrink-0 text-muted-foreground transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[color:var(--primary)]" />
                    </a>
                  </GlassCard>
                </motion.li>
              ))}
