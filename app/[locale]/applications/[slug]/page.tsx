...
export async function generateMetadata({
  ...
  return detailPageMetadata({section: "applications", slug, locale, title, description})
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            detailPageJsonLd({section: "applications", slug, locale, title, description}),
          ),
        }}
      />
      <BackgroundLayer />
